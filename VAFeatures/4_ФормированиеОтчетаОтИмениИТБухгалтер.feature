...
И в поле с именем 'Период1ДатаНачала' я ввожу текст '01.07.2025'
...
Тогда табличный документ "ОтчетТабличныйДокумент" содержит строки по шаблону:
	...
	| 'ИП Степ А.Н.'      | 'Абонентский договор № 2 от 01.07.2025 г.' | '15 000,00'      | ''               |
	| 'ООО "Антон"'       | 'Абонентский договор № 3 от 01.07.2025 г.' | '18 000,00'      | '6 000,00'               |
